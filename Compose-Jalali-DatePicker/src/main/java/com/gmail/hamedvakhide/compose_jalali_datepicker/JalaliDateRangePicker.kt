...
fun JalaliRangePickerView(
    ...
    initialRange: Pair<JalaliCalendar?, JalaliCalendar?> = Pair(null, null),
    onSelectRang: (Pair<JalaliCalendar, JalaliCalendar?>) -> Unit,
    onConfirm: (Pair<JalaliCalendar, JalaliCalendar?>) -> Unit,
    onDismiss: () -> Unit,
    ...
    var jalali by remember {
        mutableStateOf(initialRange.first ?: JalaliCalendar())
    }
                        ...
                        Row(
                            ...
                            for (i in 7 downTo 1) {
                                if (day > 0 && day <= jalali.monthLength) {
                                    ...
                                    OutlinedIconButton(
                                        onClick = {
                                            selectedDate = if (selectedDate.first == null)
                                                Pair(
                                            ...
                                            else if (selectedDate.second == null) {
                                                ...
                                                val isFirstBigger = first.toGregorian().after(second.toGregorian())
                                                selectedDate.copy(
                                        ...
                                        colors = IconButtonDefaults.filledIconButtonColors(
                                            containerColor = if (
                                                selectedDate.first == JalaliCalendar(
                                                    jalali.year,
                                                    jalali.month,
                                                    day
                                                ) ||
                                                selectedDate.second == JalaliCalendar(
                                                    jalali.year,
                                                    jalali.month,
                                                    day
                                                )
                                                ...
                                                selectedDate.second != null &&
                                                selectedDate.first!!
                                                    .toGregorian()
                                                    .before(
                                                        jalali.apply { this.day = day }
                                                            .toGregorian()
                                                    ) &&
                                                selectedDate.second!!
                                                    .toGregorian()
            ...
            if (pickerType == PickerType.Day) {
                Row(
                    ...
                    Row {
                        ...
                        TextButton(
                            modifier = Modifier.padding(horizontal = 8.dp),
                            enabled = selectedDate.first != null,
                            onClick = {
                                onConfirm(Pair(selectedDate.first!!, selectedDate.second))
                            }) {
                            Text(
                                text = "تایید",
                                style = buttonsTextStyle,
